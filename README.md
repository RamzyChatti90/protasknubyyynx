...
![CI status](https://github.com/protasknubyyynx/protasknubyyynx/actions/workflows/main.yml/badge.svg)
...
To build the final jar and optimize the protasknubyyynx application for production, run:
