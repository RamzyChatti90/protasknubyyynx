...
/**
 * REST controller for managing {@link com.protasknubyyynx.domain.Priority}.
 */
@RestController
...
public class PriorityResource {
    ...
    public ResponseEntity<PriorityDTO> createPriority(@Valid @RequestBody PriorityDTO priorityDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/priorities/" + priorityDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, priorityDTO.getId().toString()))
            .body(priorityDTO);
    }
    ...
    public ResponseEntity<PriorityDTO> partialUpdatePriority(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, priorityDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<PriorityDTO>> getAllPriorities(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of Priorities");
        Page<PriorityDTO> page = priorityService.findAll(pageable);
