...
public class DashboardDataDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(tasksByStatus, that.tasksByStatus) && Objects.equals(tasksByPriority, that.tasksByPriority)
        );
    }
    ...
    public String toString() {
        return "DashboardDataDTO{" + "tasksByStatus=" + tasksByStatus + ", tasksByPriority=" + tasksByPriority + '}';
    }
}
