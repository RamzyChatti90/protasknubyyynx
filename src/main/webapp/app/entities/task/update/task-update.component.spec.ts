...
describe('Task Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('should call Priority query and add missing value', () => {
      const task: ITask = { id: 22244 };
      const priority: IPriority = { id: 1970 };
      task.priority = priority;

      const priorityCollection: IPriority[] = [{ id: 1970 }];
    ...
    it('should update editForm', () => {
      ...
      expect(comp.prioritiesSharedCollection).toContainEqual(priority);
