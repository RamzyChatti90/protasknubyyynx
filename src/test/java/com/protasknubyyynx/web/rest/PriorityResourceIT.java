...
class PriorityResourceIT {
    ...
    void createPriority() throws Exception {
        ...
        var returnedPriorityDTO = om.readValue(
            restPriorityMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(priorityDTO)))
    ...
    void putWithMissingIdPathParamPriority() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPriorityMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(priorityDTO)))
    ...
    void patchWithMissingIdPathParamPriority() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPriorityMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(priorityDTO)))
            .andExpect(status().isMethodNotAllowed());
