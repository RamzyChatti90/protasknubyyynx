...
import static com.protasknubyyynx.domain.ProjectAsserts.*;
...
import com.protasknubyyynx.service.mapper.ProjectMapper;
...
class ProjectResourceIT {
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.description(UPDATED_DESCRIPTION).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
